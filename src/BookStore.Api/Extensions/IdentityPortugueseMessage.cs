...
namespace BookStore.Api.Extensions
{
    public class IdentityPortugueseMessage : IdentityErrorDescriber
    {
        ...
        public override IdentityError LoginAlreadyAssociated() { return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = "Já existe um usuário com este usuário." }; }
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"Usuário '{userName}' é inválido, um usuário deve conter apenas letras ou dígitos." }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = "Senhas devem conter ao menos um caracter em letra minúscula ('a'-'z')." }; }
